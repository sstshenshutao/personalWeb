...
@RestController @RequestMapping("/document") public class DocumentController {
  ...
  public List<DocumentEntry> allDocs () {
    ...
    ret.add(new DocumentEntry("Representation", webPrefix +":"+ serverPort + documentPath + "/Representation"));
    return ret;
  }
  ...
  public RepresentationDocumentEntry representationDocs () {
    String htu =
      "we use a dumpfile object to input the information, and the com.cybertaotao.representation will output the "
