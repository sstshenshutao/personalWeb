...
public class WebRepresentator implements Representator {
  ...
  //has htmlLayout for print style
  private HtmlLayout htmlLayout;
  // TODO: 16.05.19 change to the resource dir and check it
...
//  private final static String TEMPLATE_FILE_NAME = "template.html";
  public WebRepresentator () {
//    throw new RuntimeException(WebRepresentator.class.getResource(TEMPLATE_FILE_NAME).getFile());
//    this.htmlLayout = HtmlLayout.parseTemplateHtml(WebRepresentator.class.getResource(TEMPLATE_FILE_NAME).getFile());
    this.htmlLayout = HtmlLayout.parseTemplateHtml(TEMPLATE_FILE_NAME);
  }
  ...
  public String drawOut (DumpFile dumpFile) {
